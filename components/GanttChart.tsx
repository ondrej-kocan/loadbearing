      ...
      <div className="px-4 sm:px-6 min-w-0">
        <div className="overflow-x-auto pb-4">
          ...
          <div className="flex border-b border-gray-200 pb-2 mb-4">
            <div className="w-32 sm:w-48 flex-shrink-0 pr-3 sm:pr-4 sticky left-0 bg-white z-20 border-r border-gray-200 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.1)]">
            ...
            {tasksWithDates.map((task) => {
              ...
              return (
                <div key={task.id} className="flex">
                  {/* Task Name */}
                  <div className="w-32 sm:w-48 h-[52px] flex-shrink-0 pr-3 sm:pr-4 sticky left-0 bg-white z-20 border-r border-gray-200 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.1)] flex flex-col justify-start pt-1 -mb-3">
