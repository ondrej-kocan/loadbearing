      ...
      <div className="px-4 sm:px-6 min-w-0">
        <div className="overflow-x-auto pb-4">
          ...
          <div className="flex border-b border-gray-200 pb-2 mb-4">
            <div className="w-32 sm:w-48 flex-shrink-0 sticky left-0 bg-white z-10 border-r border-gray-200">
            ...
            {tasksWithDates.map((task) => {
              ...
              return (
                <div key={task.id} className="flex items-center">
                  {/* Task Name */}
                  <div className="w-32 sm:w-48 flex-shrink-0 pr-2 sm:pr-4 sticky left-0 bg-white z-10 border-r border-gray-200">
